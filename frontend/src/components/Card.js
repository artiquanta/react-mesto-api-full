...
function Card(props) {
  ...
  return (
    <li className="cards__item">
      {card.owner === currentUser._id ? <button className="cards__remove-btn" onClick={handleDeleteClick} /> : ''}
      ...
      <div className="cards__description">
        ...
        <div className="cards__likes">
          <button className={`cards__like-btn ${card.likes.includes(currentUser._id) ? 'cards__like-btn_active' : ''}`} onClick={handleLikeClick} />
